...
It reduces the majority class and makes both classes equal.
Risk: loss of useful data

2️.Random Over-Sampling:
It duplicates minority class samples and improves fraud detection.
Risk: overfitting

3.SMOTE (Synthetic Minority Over-sampling Technique)
It generates synthetic fraud samples and preserves data diversity.

4.NearMiss
It selects majority samples closest to minority class and do aggressive under-sampling
Lower performance observed

5.SMOTE-Tomek
It is combination of over-sampling + cleaning noisy samples
